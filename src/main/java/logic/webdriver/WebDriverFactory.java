...
public class WebDriverFactory {
         ...
         *
         * @param username : username for BASIC authentication on the help to test
         *
         * @param password : password for BASIC authentication on the help to test
         *
        ...
        public static WebDriver getInstance(String browser, String username,
            ...
            if (CHROME.equals(browser)) {
                ...
                System.setProperty("webdriver.ie.driver","C:\\Tools\\IEDriverServer32\\IEDriverServer.exe");
